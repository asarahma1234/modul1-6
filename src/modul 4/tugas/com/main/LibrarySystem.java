...
public class LibrarySystem {
    ...
    public static void main(String[] args) {
        daftarBuku[i++] = new StoryBook("SB32F", "Bapakku", 17, "Story", "Martis");
        daftarBuku[i++] = new HistoryBook("HB324", "Ibukku", 2, "History", "Moskov");
        daftarBuku[i++] = new TextBook("TB323", "Kakakku", 4, "Text", "Eudora");

        // Mengisi daftar mahasiswa
        studentList.add(0, new Student("202310370311201", "Asa saila rahma", "Teknik","Mesin"));
        studentList.add(1, new Student("202310370311202", "Revaldo", "Teknik","Informatika"));
        studentList.add(2, new Student("202310370311203", "Asfa ahmad", "Teknik","Elektro"));
